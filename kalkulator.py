...
e["font"]= myfont
e["bg"] = "#d1d1d1"
e.grid(row = 0,columnspan=6,pady=25,padx=25)
...
tam = Button(root,text="+",padx = 30,bg="#3d3d3d",fg="#FFFFFF", pady = 20,command=tambah)
kur = Button(root,text="-",padx = 30,bg="#3d3d3d",fg="white", pady = 20,command=kurang)
bag  = Button(root,text="/",padx = 30,bg="#3d3d3d",fg="white", pady = 20,command=bagi)
kal = Button(root,text="x",padx = 30,bg="#3d3d3d",fg="white", pady = 20,command=kali)
pang = Button(root,text="x2",padx = 25,bg="#3d3d3d",fg="white", pady = 30,command=pangkat)
ak2 = Button(root,text="sq2",padx = 25,bg="#3d3d3d",fg="white", pady = 30,command=akar)
sisbag = Button(root,text="%",padx = 30,bg="#3d3d3d",fg="white", pady = 20,command=sisabagi)
hap = Button(root,text="C",padx = 30,bg="#3d3d3d",fg="white", pady = 20,command=hapus)
equal = Button(root,text="=", padx = 70,bg="skyblue", pady =30 ,command=samadengan)
